...
document.getElementById('reset-button').addEventListener('click', () => {
    ...
    const confirmReset = window.confirm("Êtes-vous sûr de vouloir réinitialiser la session ? Cela effacera toutes les données.");
   // Si l'utilisateur confirme, procéder à la réinitialisation
    if (confirmReset) {
